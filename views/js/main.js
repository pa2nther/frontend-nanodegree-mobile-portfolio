...
var pizzaElementGenerator = function(i) {
  ...
  pizzaContainer.style.height = "225px";           //changed from 325 px to see effect on time
...
var resizePizzas = function(size) { 
  ...
  //to reduce time i moved this inside sizeswitcher
...
*/
  ...
  function changePizzaSizes(size) {
    var oldwidth = document.querySelectorAll(".randomPizzaContainer")[1].offsetWidth;
   var windowwidth = document.querySelector("#randomPizzas").offsetWidth;
   var oldsize = oldwidth / windowwidth;
   var newsize=0;
    // TODO: change to 3 sizes? no more xl?
...
//reduced number of pizzas in half to increase page speed
for (var i = 2; i < 50; i++) {
...
//reduced the number of sliding pizzas by 30 to reduce time
